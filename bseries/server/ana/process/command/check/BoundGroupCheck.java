 ...
 * @see       
 */
public class BoundGroupCheck implements ICheck{
	private static final int MIN_DSL_INTERFACE_NUM=1;
	private static final int MAX_DSL_INTERFACE_NUM=24;
	@Override
