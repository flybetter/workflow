...
public class TLVB6TemplatePersistence extends TLVPersistence{
    public TLVB6TemplatePersistence(RecordType pType) {
        super(pType);
    }
    ...
    public IQuery createQuery(IQueryScope pScope) throws QueryException {
        ...
        return new TLVB6TemplateQuery(m_handler, pScope);
    }
}
